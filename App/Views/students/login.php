    ...
    <form action="" method="post" >
        <fieldset>
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text"  class="user_id form-control" placeholder="Enter Admission number" onkeypress="return isNumeric(event)"/>
            </div>
            <div class="form-group col-md-12">
                <label for="pwd">Password</label>
                <input type="password"  class="pwd form-control" placeholder="Enter Password" />
            </div>
            <div class="form-group col-md-12  ">
